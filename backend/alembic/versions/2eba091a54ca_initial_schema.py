...
Revision ID: 2eba091a54ca
Revises: 
Create Date: 2024-08-09 18:07:05.414361
...
revision: str = '2eba091a54ca'
down_revision: Union[str, None] = None
branch_labels: Union[str, Sequence[str], None] = None
depends_on: Union[str, Sequence[str], None] = None

# Define constant for frequently used foreign key
...
def upgrade() -> None:
    ...
    sa.ForeignKeyConstraint(['user_id'], [USERS_USER_ID], ),
    sa.PrimaryKeyConstraint('id')
    )
    ...
    sa.Column('preference_type', sa.String(length=255), nullable=True),
